...
# # url =  "postgresql://username:password@hostname:port/API"
# # Fake user database
# fake_users_db = {
#     "user1@example.com": {"password": "password123", "full_name": "User One"},
#     "user2@example.com": {"password": "secret", "full_name": "User Two"},
# }
...
#     fake_users_db[email] = {"password": password, "full_name": full_name}
#     return {"message": "Sign up successful", "user": full_name}
...
#     new_user = enrty(email=email, password=hashed_password, full_name=full_name)
#     db = SessionLocal()
#     db.add(new_user)
#     db.commit()
#     db.close()
